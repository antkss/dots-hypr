...
const CHAT_MODELS = ["llama3-70b-8192"]
...
class GPTService extends Service {
    ...
    _modelIndex = 0;
    _key = '';
    _key_file_location = `${GLib.get_user_config_dir()}/${PROVIDERS[this._currentProvider]['key_file']}`;
    _url = GLib.Uri.parse(PROVIDERS[this._currentProvider]['base_url'], GLib.UriFlags.NONE);
    
    _decoder = new TextDecoder();

    _initChecks() {
        this._key_file_location = `${GLib.get_user_config_dir()}/${PROVIDERS[this._currentProvider]['key_file']}`;
